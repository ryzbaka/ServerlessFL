...
if __name__=='__main__':
    ...
    for i in range(1,11):
        ...
        training_data.to_csv(f"fedavgprocesseddatasets/fed_training_data{i}.csv",index=False)
        ...
        validation_data.to_csv(f"fedavgprocesseddatasets/fed_validation_data{i}.csv",index = False)
        ...
        testing_data.to_csv(f"fedavgprocesseddatasets/fed_testing_data{i}.csv",index = False)